			...
			<tr>
				<td align="left">
					<table border="0"  bgcolor="<?php echo couleur(1) ?>" cellpadding="4" cellspacing="0" width="80">
						<tr>
							<td align="center">
								<a href="<?php echo $retour ?>?lg=<?php echo $lg ?>&idressource=<?php echo $idressource ?>&idprofil=<?php echo $idprofil ?>&refpage=<?php echo $refpage ?>"><span class="texte_menu"><?php echo versionlinguistique(26) //Retour ?></span></a>
							</td>
						</tr>
					</table>
				</td>
				<td align="right">
<?php if (isset($fichierserveur)) { ?>
					<table border="0"  bgcolor="<?php echo couleur(1) ?>" cellpadding="4" cellspacing="0" width="80">
						<tr>
							<td align="center">
								<a href="ressources_transcription_editer_modifier.php?lg=<?php echo $lg ?>&idressource=<?php echo $idressource ?>&idprofil=<?php echo $idprofil ?>&refpage=<?php echo $refpage ?>" target="_top"><span class="texte_menu"><?php echo versionlinguistique(110) //créer ?></span></a>
							</td>
						</tr>
					</table>
...
<?php } else { ?>
					<table border="0"  bgcolor="<?php echo couleur(1) ?>" cellpadding="4" cellspacing="0" width="80">
						<tr>
							<td align="center">
								<a href="ressources_transcription_editer_modifier.php?lg=<?php echo $lg ?>&idressource=<?php echo $idressource ?>&idprofil=<?php echo $idprofil ?>&refpage=<?php echo $refpage ?>" target="_top"><span class="texte_menu"><?php echo versionlinguistique(41) //Modifier ?></span></a>
							</td>
						</tr>
					</table>
<?php } ?>
