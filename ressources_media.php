...
// ***************************************************************
	...
	$recup = mysql_query($query);
		while ($data = mysql_fetch_assoc($recup))
			{
			$consultation = $data['consultation']; // r�cup�ration des consultations
		}
...
// ***************************************************************
	...
	$visiteur = $visiteur + 1; // variable r�cup�rer pr�c�dement dans Recup_infosRessource
...
$nbonglet=0;
//************************************************************************
//			V�rification pr�sence media, transcription et vignette
//************************************************************************
$nbmedia=0;
...
$soustitre=0;
$filename = 'ressources/'.$idressource.$lg.'.srt';
if (file_exists($filename)) {
...
//************************************************************************
//		Nombre de conseils associ�s � cette ressource
//************************************************************************
...
<?php if ($motcle<>"") { ?>
	...
	<?php } ?>
										...
										<td align="center" bgcolor="<?php echo couleur(2); //couleur fonc�e ?>">
...
<?php if ($_SESSION['niveau']>0) { ?>
										<td width="40" align="right" bgcolor="<?php echo couleur(1); //couleur fonc�e ?>">
...
<!-- ----------------------------------------------------------------------- -->
	<!-- V�rification et affichage vignette -->
		<?php if ($vignette=="") { ?>
