...
//**********************************
		...
		if ($nb>2) {
			...
			$nb=0;
				...
				if ($_SESSION['niveau']>1) { // affichage du bouton d'�dition de la cat�gorie
					echo '<tr><td>';
						echo '<table border="0" cellpadding="4" cellspacing="0" bgcolor="'.couleur(1).'" width="200">';
							echo '<tr>';
								echo '<td align="center"><a href="categorie_edit.php?lg='.$lg.'&id='.$data['id'].'"><span class="texte_info12">'.content("line205_216").'</span></a></td>'; //�diter
							echo '</tr>';
						echo '</table>';
					echo '</td></tr>';
							}
...
<?php if ($_SESSION['niveau']>=50) { // Affichage Bouton �dition page ?>
											<table border="0" cellpadding="4" cellspacing="2" bgcolor="<?php echo couleur(1); //couleur fonc�e ?>" width="220">
												<tr>
													<td align="center"><a href="categorie_ajouter.php?lg=<?php echo $lg ?>&page=<?php echo $pageencours ?>"><span class="texte_info12"><?php echo new_versionlinguistique("text43")// Ajouter une cat�gorie ?></span></a></td>
												</tr>
											</table>
<?php } ?>
</div>
