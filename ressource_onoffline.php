...
$requete ='UPDATE `ressources` SET `offline`='.$flag.' WHERE id='.$id; // requete de mise à jour
echo $requete.'<br>';
...
$route='Location: '.$page.'?lg='.$lg.'&action=ok&idprofil='.$idprofil.'&categorie='.$categorie.'#'.$id;
