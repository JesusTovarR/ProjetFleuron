...
include('include/affichage_page.inc'); // routine affichant le contenu rédactionnel d'une page
								...
								<table width="100%" cellpadding="0" cellspacing="0" bgcolor="<?php echo couleur(2); //couleur claire ?>" width="220">
									<tr>
										<td align="center" height="30">
											<span class="titre"><?php echo conseils("line55"); //Qu'est ce que Fleuron ?></span>
										</td>
									</tr>
								</table>
<br>
