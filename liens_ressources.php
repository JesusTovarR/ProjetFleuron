						...
						while ($data2 = mysql_fetch_assoc($recup2))
							...
							if ($_SESSION['niveau']>=50) {
									echo '<td width="100">';
										echo '<table border="0" cellpadding="6" cellspacing="2" bgcolor="'.couleur(1).'">';
											echo '<tr>';
												echo '<td colspan="2"><a href="liens_ressources_modifier.php?lg='.$lg.'&id='.$data2['id'].'&page='.$pageencours.'"><span class="texte_info12">'.versionlinguistique(47).'</span></a></td>'; // Editer
											echo '</tr>';
										echo '</table>';
									echo '</td>';
									echo '<td width="100">';
										echo '<table border="0" cellpadding="6" cellspacing="2" bgcolor="'.couleur(1).'">';
											echo '<tr>';
												echo '<td colspan="2"><a href="liens_ressources_supprimer.php?lg='.$lg.'&id='.$data2['id'].'&page='.$pageencours.'"><span class="texte_info12">'.versionlinguistique(48).'</span></a></td>'; // Supprimer
											echo '</tr>';
										echo '</table>';
									echo '</td>';
							}
...
<?php if ($_SESSION['niveau']>=50) { // Affichage Bouton ajouter une cat�gorie ?>
											<table border="0" cellpadding="4" cellspacing="2" bgcolor="<?php echo couleur(1); //couleur fonc�e ?>" width="220">
												<tr>
													<td align="center"><a href="liens_ressources_categorie_ajouter.php?lg=<?php echo $lg ?>&id=1&page=<?php echo $pageencours ?>"><span class="texte_info12"><?php echo versionlinguistique(43) //Ajouter une cat�gorie ?></span></a></td>
												</tr>
											</table><br>
<?php } ?>
