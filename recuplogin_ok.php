...
include('include/affichage_page.inc'); // afficher le contenu r�dactionnel d'une page
...
<center>
<br><br><br>
<span class="texte_defaultGras"><?php echo new_versionlinguistique("text144"); //un mail vous a �t� envoy� ?></span><br><br>
