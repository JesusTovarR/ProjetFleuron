...
$donnee=mysql_query('SELECT refVL FROM lienRessources_categories ORDER BY id DESC LIMIT 1');
while ($donnee = mysql_fetch_assoc($donnee))
{ $dernierrefVL = $donnee['refVL']; }

$dernierrefVL = $dernierrefVL + 10;

$requete ='INSERT INTO `liensRessources_categories` (`id`,`refVL`,'; // début de la composition de la requete de mise à jour
//**************************
...
header('Location: liens_ressources.php?lg='.$_POST["langue"]); // redirection
