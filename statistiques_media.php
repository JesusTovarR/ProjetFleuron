...
function affichage_concordancier()
	{
		...
		$requete = 'SELECT id,visiteur FROM ressources ORDER BY visiteur DESC';
...
include('include/affichage_ressource_statistiques.inc'); // affichage des ressources dans une liste	
?>
