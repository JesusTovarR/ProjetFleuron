...
<center>
	<form name="FormName" action="liens_ajouter_enre.php" method="post">
<br><br><br>
	<table border="0">
		<tr>
			<td>
...
?>
		...
		<tr>
			<td>
				<span class="texte_default"><?php echo versionlinguistique(18) //Nom ?> :</span>
			</td>
			<td>
		...
		<tr>
			<td>
				<span class="texte_default"><?php echo versionlinguistique(53) //Lien ?> :</span>
			</td>
			<td>
