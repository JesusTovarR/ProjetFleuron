...
$requete ='UPDATE glossaire SET item="'.addslashes($_POST['item']).'",'; // début de la composition de la requete de mise à jour
...
header('Location: glossaire.php?lg='.$lg.'&action=ok&id='.$id.'#'.$id); // redirection
