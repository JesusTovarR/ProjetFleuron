...
<!-- Partie centrale -->
						...
						<tr>
							<td align="center">
		<form name="FormName" action="commentaire_repondre_enre.php" method="post">
		<table border="0" cellpadding="2" cellspacing="2">
			<tr>
				<td>
					<p><?php echo general("text8");//r�pondre ?> :</p>
			...
			<input type="hidden" value="<?php echo $idcommentaire ?>" name="idcommentaire">
		</form>
							</td>
						</tr>
					</table>
