...
$requete ='UPDATE liensRessources_categories SET '; // début de la composition de la requete de mise à jour
...
header('Location: liens_ressources.php?lg='.$lg.'&action=ok'); // redirection
