									...
									<tr>
										<td width="150">
											<table border="0"  bgcolor="<?php echo couleur(1) ?>" cellpadding="5" cellspacing="0" width="150">
												<tr>
													<td align="center">
														<a href="profils_pays_list.php?lg=<?php echo $lg ?>&id=<?php echo $id ?>&niveau=<?php echo $niveau ?>&pays=<?php echo $pays ?>"><span class="texte_menu"><?php echo general("text5") //Retour ?></span></a>
													</td>
												</tr>
											</table>
										</td>
									...
									<table border="0" cellpadding="10" cellspacing="2">
										...
										<tr>
											...
											<table border="0"  bgcolor="<?php echo couleur(1) ?>" cellpadding="5" cellspacing="0" width="150">
												<tr>
													<td align="center">
														<a href="profils_pays_list_supprimer_enre.php?lg=<?php echo $lg ?>&id=<?php echo $id ?>&niveau=<?php echo $niveau ?>&pays=<?php echo $pays ?>"><span class="texte_menu"><?php echo afficher_ressource("option2") //supprimer ?></span></a>
													</td>
												</tr>
											</table>												<center>
