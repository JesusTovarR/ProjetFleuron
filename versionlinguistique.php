...
function affichageversionlinguistique()
	{
		global $lg,$action,$action2,$idvl; // r�cup�ration variables de connexion
								...
								echo '<td width="300" align="center" valign="top">';
									if ($action=="ok" AND $donnees['id']==$idvl) {
										echo '<table border="0" cellpadding="4" cellspacing="2" bgcolor="'.couleur(1).'" width="220">';
											echo '<tr>';
												echo '<td align="center"><a href="#"><span class="texte_info12">'.new_versionlinguistique("text74").'</span></a></td>'; // version linguistique modifi�e
											echo '</tr>';
										echo '</table>';
									}
									if ($action2=="ok" AND $donnees['id']==$idvl) {
										echo '<table border="0" cellpadding="4" cellspacing="2" bgcolor="'.couleur(1).'" width="220">';
											echo '<tr>';
												echo '<td align="center"><a href="#"><span class="texte_info12">'.new_versionlinguistique("text76").'</span></a></td>'; // version linguistique modifi�e
											echo '</tr>';
										echo '</table>';
									}
								echo '</td>';
