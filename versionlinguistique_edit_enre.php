...
$requete ='UPDATE versionlinguistique SET '; // début de la composition de la requete de mise à jour
...
header('Location: versionlinguistique.php?lg='.$lg.'&action=ok&id='.$id.'#'.$id); // redirection
